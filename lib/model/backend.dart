...
class Backend {
  ...
  final _emails = [
    Email(
      id: 631,
      from: 'Anthonyx57@programming.com',
      subject: 'Programacion Functional',
    ...
    Email(
      id: 522,
      from: 'Ana@programming.com',
      subject: 'Programacion Declarativa',
    ...
    Email(
      id: 963,
      from: 'Lleyton@programming.com',
      subject: 'Programacion Imperativa',
    ...
    Email(
      ...
      subject: 'Lenguaje de Programacion de alto nivel',
